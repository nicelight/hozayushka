...
- Settings & Location owns validated Settings, selected location and the
  persisted glass-personalization values; it may request Weather Context's
  refresh contract after a valid location change. Main Display consumes the
  validated presentation projection through the existing edge above.
